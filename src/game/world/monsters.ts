...
export const MONSTERS: Record<MonsterType, MonsterSpec> = {
  green_blob: { ...common, name: "초록 슬라임", hp: 60, damage: 6, speed: 1.6, xp: 8 },
  mushnub: { ...common, name: "버섯돌이", hp: 70, damage: 7, xp: 9 },
  rat: { ...common, name: "들쥐", hp: 55, damage: 8, speed: 2.4, xp: 9 },
  frog: { ...common, name: "개구리", hp: 80, damage: 9, xp: 11 },
  spider: { ...common, name: "숲거미", hp: 130, damage: 14, speed: 2.2, aggro: 11, xp: 20 },
  snake: { ...common, name: "독사", hp: 110, damage: 16, aggro: 10, xp: 20 },
  wasp: { ...common, name: "말벌", hp: 100, damage: 13, speed: 2.6, aggro: 12, xp: 20 },
  goleling: { ...common, name: "골렘링", hp: 160, damage: 16, speed: 1.7, aggro: 10, body: 0.5, xp: 26 },
  bat: { ...common, name: "박쥐", hp: 90, damage: 12, speed: 2.8, aggro: 12, xp: 18 },
  mushroom_king: {
...
// Player hits land a little harder with every level.
export function damageAt(base: number, level: number): number {
  return Math.round(base * (1 + (Math.max(1, level) - 1) * 0.06));
}
