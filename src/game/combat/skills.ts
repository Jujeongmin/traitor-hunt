...
export const SKILLS: Record<PlayerClass, readonly Skill[]> = {
  warrior: [
    ...
    {
      ...base, name: "돌진 베기", blurb: "앞을 크게 베어 잠시 넘어뜨린다", level: 5,
      cooldownMs: 9000, damage: 75, reach: 4, arc: deg(70), stunMs: 800,
    },
    {
      ...base, name: "대지 강타", blurb: "땅을 내리쳐 주변을 모두 기절시킨다", level: 10,
  ...
  ranger: [
    ...
    {
      ...base, name: "조준 사격", blurb: "하나를 노려 크게 맞힌다", level: 5,
      cooldownMs: 6000, damage: 80, reach: 14, arc: deg(30), maxTargets: 1,
    },
    { ...base, name: "화살비", blurb: "주변에 화살을 쏟아붓는다", level: 10, cooldownMs: 18000, damage: 90, reach: 7, arc: all },
  ],
  wizard: [
    { ...base, name: "화염 폭발", blurb: "주변을 불꽃으로 덮어 몬스터를 태운다", level: 1, cooldownMs: 10000, damage: 50, reach: 4.5, arc: all },
    {
      ...base, name: "얼음 창", blurb: "하나를 꿰뚫고 얼려 움직이지 못하게 한다", level: 5,
      cooldownMs: 8000, damage: 60, reach: 11, arc: deg(20), maxTargets: 1, stunMs: 2000,
    },
    { ...base, name: "운석 낙하", blurb: "하늘에서 불덩이를 떨어뜨려 주변을 태운다", level: 10, cooldownMs: 22000, damage: 140, reach: 6, arc: all },
  ],
  cleric: [
    { ...base, name: "치유의 빛", blurb: "자신과 가까운 동료의 체력을 회복한다", level: 1, cooldownMs: 12000, damage: 0, reach: 6, arc: all, heal: 35 },
    {
      ...base, name: "신성한 일격", blurb: "지팡이에 빛을 실어 앞을 치고 기절시킨다", level: 5,
      cooldownMs: 8000, damage: 60, reach: 3, arc: deg(110), stunMs: 1000,
    },
    {
      ...base, name: "축복", blurb: "주변 몬스터를 태우고 동료를 크게 회복한다", level: 10,
  ...
  rogue: [
    ...
    { ...base, name: "칼날 부채", blurb: "앞으로 단검을 흩뿌린다", level: 5, cooldownMs: 6000, damage: 55, reach: 5, arc: deg(100) },
    { ...base, name: "그림자 난무", blurb: "주변을 휘저으며 모두 벤다", level: 10, cooldownMs: 18000, damage: 130, reach: 3.5, arc: all },
  ],
  monk: [
    { ...base, name: "기절 연타", blurb: "앞의 몬스터를 두들겨 잠시 기절시킨다", level: 1, cooldownMs: 10000, damage: 20, reach: 2.6, arc: deg(120), stunMs: 2500 },
    { ...base, name: "회오리 발차기", blurb: "돌며 차서 주변을 모두 때린다", level: 5, cooldownMs: 7000, damage: 50, reach: 2.8, arc: all },
    {
      ...base, name: "백열권", blurb: "하나에게 온 힘을 실은 주먹을 꽂는다", level: 10,
